...
describe('normalizeOptionalDateInput', () => {
  ...
  it('normalizes flexible date formats into YYYY-MM-DD strings', () => {
    ...
    expect(normalizeOptionalDateStringInput('23-03-2026 14:30')).toBe(
      '2026-03-23',
    );
