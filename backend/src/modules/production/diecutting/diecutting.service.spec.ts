...
describe('DiecuttingService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: require('../../inventory/stock/stock.service').StockService, useValue: mockStockService },
      ],
    }).compile();
  ...
  describe('createReport', () => {
    it('should create a diecutting report and automatic stock entry', async () => {
      mockPrisma.diecutReport.create.mockResolvedValue({ id: 'rep-1', good_units: 500 });
      ...
      const result = await service.createReport({
        ...
        machine_id: 'mach-1',
        activities: [
          { activity_type: DiecutActivityType.RUN, quantity: 500, start_time: '08:00' }
        ],
        die_status: 'OK',
      ...
      expect(mockStockService.create).toHaveBeenCalledWith(expect.objectContaining({
        quantity: 500,
      }));
    ...
    it('should throw ConflictException if overlaps exist', async () => {
      ...
      await expect(service.createReport({
        ...
        machine_id: 'mach-1',
        activities: [
          { activity_type: DiecutActivityType.RUN, start_time: '08:00', end_time: '10:00' }
        ],
