      ...
      shifts: [
        {
          ...
          end_time: this.normalizeContractTime(newConfig.shiftEndTime1, normalizedShifts[0]?.endTime || '14:00'),
        ...
        },
        {
          ...
          end_time: this.normalizeContractTime(newConfig.shiftEndTime2, normalizedShifts[1]?.endTime || '22:00'),
          crosses_midnight: false,
          active: true,
        },
      ],
  ...
  private normalizeSystemConfigContract(contract: any): SystemConfigContract {
    ...
    return {
      system_config: {
        ...
        shiftEndTime1: normalizedShifts[0]?.endTime || currentConfig.shiftEndTime1,
        ...
        shiftEndTime2: normalizedShifts[1]?.endTime || currentConfig.shiftEndTime2,
      },
